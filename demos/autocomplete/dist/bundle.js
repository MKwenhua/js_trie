...
var _list_item = __webpack_require__(30);

var _list_item2 = _interopRequireDefault(_list_item);

var _result_action = __webpack_require__(31);
...
var Layout = function (_PureComponent) {
  ...
  function Layout() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Layout.__proto__ || Object.getPrototypeOf(Layout)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var suggestions = _autocomplete.AutoComplete.lookup(typed);
      console.log('suggestions', suggestions);
      _this.setState({ suggestions: suggestions, typed: typed });
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      var movieSuggestions = suggestions.map(function (itm, i) {
        ...
        if (typeof itm === 'string') {
          ...
          return _react2.default.createElement(_list_item2.default, { key: i, data: data });
        }
        return _react2.default.createElement(_result_action2.default, { key: i, data: itm });
      });
      return _react2.default.createElement(
        'div',
        { className: 'row' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { onKeyUp: this.searchType, type: 'text', className: 'form-control', placeholder: 'Search' }),
              _react2.default.createElement(
                'span',
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      var _props$data = this.props.data,
          suggestion = _props$data.suggestion,
          typed = _props$data.typed;
...
var ResultAction = function (_PureComponent) {
  _inherits(ResultAction, _PureComponent);
  ...
  _createClass(ResultAction, [{
    ...
    value: function render() {
      var _props$data = this.props.data,
          word = _props$data.word,
          img_src = _props$data.img_src,
          imdb = _props$data.imdb;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'col-xs-1' },
          _react2.default.createElement('img', { src: img_src, height: '60' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'col-xs-10' },
...
var _actionAutocomplete = __webpack_require__(34);

var _actionAutocomplete2 = _interopRequireDefault(_actionAutocomplete);

var _word_list = __webpack_require__(35);

var _word_actions = __webpack_require__(36);

var _special_offers = __webpack_require__(37);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var AutoComplete = (0, _actionAutocomplete2.default)(_word_list.WordList, _extends({}, _word_actions.WordActions, _special_offers.SpecialOffers));
...
exports.SpecialOffers = undefined;
...
var MovieDiscount = function (_React$PureComponent) {

...
var EX2 = (0, _reactalike.exNode)('what');
console.log('EX2', EX2);
...
var NameTag = _reactalike2.default.component({
  ...
  componentRender: function componentRender(props) {
    ...
    return _reactalike2.default.node(
      ...
      _reactalike2.default.node(
        ...
        _reactalike2.default.node('div', { 'class': 'dottedline' })
      )
    );
  }
});
...
var Layout = {
  ...
  render: function render() {
    ...
    var ppl = guests.map(function (itm, ii) {
      return _reactalike2.default.node(NameTag, { ex_person: itm });
    });
    return _reactalike2.default.node(
      'div',
      { 'class': 'container' },
